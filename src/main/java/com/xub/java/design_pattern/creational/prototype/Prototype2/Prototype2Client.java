package com.xub.java.design_pattern.creational.prototype.Prototype2;
...
public class Prototype2Client {
    ...
    public static void main(String[] args) throws CloneNotSupportedException {
         ...
         * 第一种实现方式：实现Cloneable接口，并重写clone方法，原型对象里面所有的引用对象均需要实现Cloneable接口（修改对应引用对象为clone方法返回的对象）
